...
\begin{figure}%
  \centering
  \subfloat[][]{\includegraphics[width=0.25\linewidth]{figures/WidgetFeatureProperty_Before.PNG}}%
  \qquad
  \subfloat[][]{\includegraphics[width=0.25\linewidth]{figures/WidgetFeatureProperty_Adaption.PNG}}%
 \qquad
  \subfloat[][]{\includegraphics[width=0.25\linewidth]{figures/WidgetFeatureProperty_Live.PNG}}%
